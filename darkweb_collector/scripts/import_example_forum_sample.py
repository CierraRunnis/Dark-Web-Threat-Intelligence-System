...
def build_parser() -> ArgumentParser:
    parser = ArgumentParser(description="Import local HTML samples for example_forum into SQLite.")
    ...
    parser.add_argument(
        "--db-path",
        default=str(ROOT / "data" / "example_forum.db"),
        help="SQLite path for the imported data",
    )
    parser.add_argument(
        "--output-json",
        default="",
...
def main() -> int:
    ...
    parser = get_parser("example_forum")
