#!/usr/bin/env python3
"""
Onion Site Crawler using Playwright - For JavaScript-rendered .onion sites

This script uses Playwright to crawl .onion websites through Tor proxy.
It can handle JavaScript-rendered content (SPA - Single Page Applications).
...
Usage:
    python fetch_onion_playwright.py <onion_url>
