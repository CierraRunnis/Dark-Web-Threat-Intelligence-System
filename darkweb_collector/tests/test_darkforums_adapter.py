...
class DarkforumsAdapterTests(unittest.TestCase):
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            with patch.dict(os.environ, {"DARKWEB_COLLECTOR_DB_PATH": str(Path(tmp_dir) / "collector.db")}, clear=False):
                config = SiteConfig(
                    ...
                    enabled=True,
                    seed_urls=(
                        "https://darkforums.ru/Forum-Databases",
                        "https://darkforums.ru/Forum-Other-Leaks",
                        "https://darkforums.ru/Forum-Sellers-Place",
                    ),
                        ...
                        "sections": [
                            {
                                "section": "databases",
                                "topics": [
                                    {"full_url": "https://darkforums.ru/db-1", "title": "db1", "content_hash": "a"},
                                    {"full_url": "https://darkforums.ru/db-2", "title": "db2", "content_hash": "b"},
                                ],
                            },
                            {
                                "section": "other_leaks",
                                "topics": [
                                    {"full_url": "https://darkforums.ru/ol-1", "title": "ol1", "content_hash": "c"},
                                    {"full_url": "https://darkforums.ru/ol-2", "title": "ol2", "content_hash": "d"},
                                ],
                            },
                            {
                                "section": "sellers_place",
                                "topics": [
                                    {"full_url": "https://darkforums.ru/sp-1", "title": "sp1", "content_hash": "e"},
                                    {"full_url": "https://darkforums.ru/sp-2", "title": "sp2", "content_hash": "f"},
                                ],
                            },
                        ]
                    },
    ...
    def test_persist_marks_normalized_events_dirty_without_inline_refresh(self) -> None:
        adapter = DarkforumsAdapter()
        with tempfile.TemporaryDirectory() as tmp_dir:
            with patch.dict(os.environ, {"DARKWEB_COLLECTOR_DB_PATH": str(Path(tmp_dir) / "collector.db")}, clear=False):
                config = SiteConfig(
                ...
                run_ctx = RunContext(
                    ...
                    target="https://darkforums.ru/thread-1",
                    started_at_utc="2026-03-11T00:00:00+00:00",
                )
                detail_result = DetailResult(
                    site_name="darkforums",
                    target_url="https://darkforums.ru/thread-1",
                    payload={
