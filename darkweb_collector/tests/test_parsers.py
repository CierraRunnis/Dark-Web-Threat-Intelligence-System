...
class ParserTests(unittest.TestCase):
    ...
    def test_darkforums_parsers_extract_list_and_detail(self) -> None:
        ...
        """
        list_result = parse_darkforums_list("https://darkforums.ru/Forum-Databases", list_html, max_topics=5)
        self.assertEqual(1, list_result["topic_count"])
        self.assertEqual("Acme Database Leak", list_result["topics"][0]["title"])

        detail_result = parse_darkforums_detail("https://darkforums.ru/Thread-123-Acme", detail_html)
    ...
    def test_darkforums_detail_prefers_first_post_body(self) -> None:
        ...
        """
        detail_result = parse_darkforums_detail("https://darkforums.ru/Thread-Website-eurojobs-com", detail_html)
