...
PLATFORMS: dict[str, ExposurePlatform] = {
    ...
    "renrendoc": ExposurePlatform(
        key="renrendoc",
        label="人人文库",
        module="document_exposure",
        platform_type="document_library",
        homepage_url="https://www.renrendoc.com/",
        login_url="https://www.renrendoc.com/renrendoc_v1/User/login.html",
        domains=("renrendoc.com", "www.renrendoc.com", "m.renrendoc.com"),
        success_indicators=("人人文库", "renrendoc"),
        login_indicators=("登录", "注册", "User/login", "Auth/index"),
    ),
    "jinchutou": ExposurePlatform(
        key="jinchutou",
        label="金锄头文库",
        module="document_exposure",
        platform_type="document_library",
        homepage_url="https://www.jinchutou.com/",
        login_url="https://im.jinchutou.com/UserManage/UserDefault.aspx",
        domains=("jinchutou.com", "www.jinchutou.com", "so.jinchutou.com", "m.jinchutou.com"),
        success_indicators=("金锄头文库", "jinchutou"),
        login_indicators=("登录", "会员中心", "UserManage"),
    ),
    "mbalib_doc": ExposurePlatform(
        key="mbalib_doc",
        label="MBA智库文档",
        module="document_exposure",
        platform_type="document_library",
        homepage_url="https://doc.mbalib.com/",
        login_url="https://doc.mbalib.com/login",
        domains=("doc.mbalib.com",),
        success_indicators=("MBA智库文档", "mbalib"),
        login_indicators=("登录", "wikidbAccessToken", "/login"),
    ),
    "wenku_360": ExposurePlatform(
        key="wenku_360",
        label="360文库",
        module="document_exposure",
        platform_type="document_library",
        homepage_url="https://wenku.so.com/",
        login_url="https://wenku.so.com/",
        domains=("wenku.so.com",),
        success_indicators=("360文库", "wenku.so.com"),
        login_indicators=("登录", "安全验证", "captcha"),
    ),
    "tencent_wenku": ExposurePlatform(
        key="tencent_wenku",
        label="腾讯文库",
        module="document_exposure",
        platform_type="document_library",
        homepage_url="https://wenku.docs.qq.com/",
        login_url="https://docs.qq.com/",
        domains=("wenku.docs.qq.com", "docs.qq.com"),
        success_indicators=("腾讯文库", "docs.qq.com"),
        login_indicators=("登录", "扫码", "QQ登录", "微信登录"),
    ),
    "quark_doc": ExposurePlatform(
        key="quark_doc",
        label="夸克文档",
        module="document_exposure",
        platform_type="document_library",
        homepage_url="https://doc.quark.cn/",
        login_url="https://doc.quark.cn/",
        domains=("doc.quark.cn",),
        success_indicators=("夸克文档", "quark"),
        login_indicators=("登录", "扫码", "安全验证"),
    ),
    "taodocs": ExposurePlatform(
        key="taodocs",
        label="淘豆网",
        module="document_exposure",
        platform_type="document_library",
        homepage_url="https://www.taodocs.com/",
        login_url="https://www.taodocs.com/",
        domains=("taodocs.com", "www.taodocs.com"),
        success_indicators=("淘豆网", "taodocs"),
        login_indicators=("登录", "会员登录"),
    ),
    "doczj": ExposurePlatform(
        key="doczj",
        label="文档之家",
        module="document_exposure",
        platform_type="document_library",
        homepage_url="https://www.doczj.com/",
        login_url="https://www.doczj.com/",
        domains=("doczj.com", "www.doczj.com"),
        success_indicators=("文档之家", "doczj"),
        login_indicators=("登录", "会员"),
    ),
    "souhong_wenku": ExposurePlatform(
        key="souhong_wenku",
        label="搜弘文库",
        module="document_exposure",
        platform_type="document_library",
        homepage_url="https://mwenku.chochina.com/",
        login_url="https://mwenku.chochina.com/",
        domains=("mwenku.chochina.com", "wenku.chochina.com"),
        success_indicators=("搜弘文库", "chochina"),
        login_indicators=("登录", "会员"),
    ),
