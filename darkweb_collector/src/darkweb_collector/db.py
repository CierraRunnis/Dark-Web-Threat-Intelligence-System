    ...
    if normalized_keyword:
        ...
        clauses.append(
            ...
            (
                ...
                OR attacker LIKE ? ESCAPE '\\' COLLATE NOCASE
                OR victim LIKE ? ESCAPE '\\' COLLATE NOCASE
                OR region LIKE ? ESCAPE '\\' COLLATE NOCASE
                OR event_metadata_json LIKE ? ESCAPE '\\' COLLATE NOCASE
            )
            """
        )
