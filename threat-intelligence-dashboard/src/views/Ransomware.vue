<template>
  <div class="ransomware-page ti-page">
      ...
      <div class="ti-card ti-reveal-up">
        <div class="ti-card-body">
          <EventTableToolbar
            eyebrow="事件表"
            title="勒索事件列表"
            description="本页以披露事件列表为主，仅保留更稳定的事实字段，趋势与排行类图表已统一收拢到威胁态势页。"
          ...
          <div class="table-footer">
            <div class="table-footer__note">共 {{ filteredEvents.length }} 条事件，图表类趋势已移至威胁态势页统一查看。</div>
            <el-pagination
