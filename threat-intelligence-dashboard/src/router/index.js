...
const DataMigration = () => import('@/views/DataMigration.vue')
...
const routes = [
  ...
  }),
  {
    ...
    meta: { title: '数据迁移', icon: 'Switch', adminOnly: true, kicker: 'Database Migration', subtitle: '导入、校验并受控切换数据库与证据镜像。', layout: 'prototype-vue' },
  },
  {
